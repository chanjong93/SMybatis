        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4">
                    ...
                    <input class="form-control bg-dark border-0" type="search" placeholder="To search....">
                </form>
...
$('#listTable > tbody').empty();
	...
	if(a2.length >=1 ){
		let str = "";
		a2.forEach(function(ww){
				console.log("ww=============",ww);
				str+="<tr>"
				str+="<td>" + ww.NT_NO + "</td>"
				str+="<td>" + '<a href="/notice/detail?NT_NO=ww.NT_NO">'
				+ ww.NT_TITLE + "</a>" + "</td>"
				str+="<td>" + ww.NT_WRITER + "</td>"
				str+="<td>" + ww.NT_WRITEDATE + "</td>"
				str+="<td>" + ww.NT_HITS + "</td>"
				str+="</tr>"	
		});
